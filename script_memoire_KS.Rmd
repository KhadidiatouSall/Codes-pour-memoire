...
# =============================================================================
# VOLATILITY & EXTREME RISK — BRVM COMPOSITE
# Full econometric framework: GARCH / EGARCH / EVT (POT)
# Author: Khadididiatou Sall
# =============================================================================
```{r}
...
# 3. Covariable : écart absolu retardé
```{r}
...
```{r}
# Mean Excess Plot avec bandes de confiance
library(POT)
...
# --- 10. Export des résultats / tableau final ----------------------------
...
library(changepoint)
ret <- as.numeric(rendements)

icss_res <- cpt.var(ret, method = "BinSeg", penalty = "MBIC")

print(icss_res)

plot(icss_res, main = "Changements de variance détectés")
